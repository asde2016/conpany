            ...
            <div class="board_container">
                <div class="table_wrapper">
                    ...
                    <div class="edit clearfix">
                        <router-link to="/department">목록</router-link>
...
export default {
    ...
    methods: {
        async getBoardDetail() {
            ...
            let b = boardDetail.length == 0
                || (boardDetail[0].m_sno != this.$store.state.user.m_sno 
                                         && this.$store.state.user.m_sno != 0);
            this.$redirect("/department", b);
        },
        async getBoardFile() {
