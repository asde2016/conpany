                ...
                <div class="board_container">
                    <div class="table_wrapper">
                        ...
                        <div class="edit clearfix">
                            <router-link to="/notice" href="#">목록</router-link>
                            <a v-if="boardDetail.m_sno == this.$store.state.user.m_sno" @click="deleteBoard()" href="#">삭제</a>
                            <a v-if="boardDetail.m_sno == this.$store.state.user.m_sno" @click="goToUpdate()" href="#">수정</a>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        goToUpdate() {
            this.$router.push({path:'/notice/update', query:{b_sno:this.boardSno}});
        },
        async deleteBoard() {
            this.$swal.fire({
                title: '정말 삭제 하시겠습니까?',
